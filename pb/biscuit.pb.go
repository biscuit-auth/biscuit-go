...
func (x *IDV2) GetSymbol() uint64 {
	if x, ok := x.GetContent().(*IDV2_Symbol); ok {
		return x.Symbol
	}
	return 0
}
...
type IDV2_Symbol struct {
	Symbol uint64 `protobuf:"varint,1,opt,name=symbol,oneof"`
}

type IDV2_Variable struct {
	Variable uint32 `protobuf:"varint,2,opt,name=variable,oneof"`
}
...
type IDV2_Date struct {
	Date uint64 `protobuf:"varint,5,opt,name=date,oneof"`
}

type IDV2_Bytes struct {
	Bytes []byte `protobuf:"bytes,6,opt,name=bytes,oneof"`
}
...
type IDV2_Set struct {
	Set *IDSet `protobuf:"bytes,8,opt,name=set,oneof"`
}

func (*IDV2_Symbol) isIDV2_Content() {}
...
func (x *ConstraintV2) GetSymbol() *SymbolConstraintV2 {
	if x, ok := x.GetConstraint().(*ConstraintV2_Symbol); ok {
		return x.Symbol
	}
	return nil
}
...
type ConstraintV2_Symbol struct {
	Symbol *SymbolConstraintV2 `protobuf:"bytes,5,opt,name=symbol,oneof"`
}

type ConstraintV2_Bytes struct {
	Bytes *BytesConstraintV2 `protobuf:"bytes,6,opt,name=bytes,oneof"`
}
...
func (*ConstraintV2_Symbol) isConstraintV2_Constraint() {}
...
type SymbolConstraintV2 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Constraint:
	//	*SymbolConstraintV2_InSet
	//	*SymbolConstraintV2_NotInSet
	Constraint isSymbolConstraintV2_Constraint `protobuf_oneof:"Constraint"`
}

func (x *SymbolConstraintV2) Reset() {
	*x = SymbolConstraintV2{}
	if protoimpl.UnsafeEnabled {
...
func (x *SymbolConstraintV2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolConstraintV2) ProtoMessage() {}

func (x *SymbolConstraintV2) ProtoReflect() protoreflect.Message {
	mi := &file_biscuit_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolConstraintV2.ProtoReflect.Descriptor instead.
func (*SymbolConstraintV2) Descriptor() ([]byte, []int) {
	return file_biscuit_proto_rawDescGZIP(), []int{16}
}

func (m *SymbolConstraintV2) GetConstraint() isSymbolConstraintV2_Constraint {
	if m != nil {
		return m.Constraint
	}
	return nil
...
func (x *SymbolConstraintV2) GetInSet() *SymbolSet {
	if x, ok := x.GetConstraint().(*SymbolConstraintV2_InSet); ok {
		return x.InSet
	}
	return nil
}

func (x *SymbolConstraintV2) GetNotInSet() *SymbolSet {
	if x, ok := x.GetConstraint().(*SymbolConstraintV2_NotInSet); ok {
		return x.NotInSet
	}
	return nil
}

type isSymbolConstraintV2_Constraint interface {
	isSymbolConstraintV2_Constraint()
}

type SymbolConstraintV2_InSet struct {
	InSet *SymbolSet `protobuf:"bytes,1,opt,name=in_set,json=inSet,oneof"`
}

type SymbolConstraintV2_NotInSet struct {
	NotInSet *SymbolSet `protobuf:"bytes,2,opt,name=not_in_set,json=notInSet,oneof"`
}

func (*SymbolConstraintV2_InSet) isSymbolConstraintV2_Constraint() {}

func (*SymbolConstraintV2_NotInSet) isSymbolConstraintV2_Constraint() {}
...
type VerifierPolicies struct {
	...
	PrivilegedRules []*RuleV2  `protobuf:"bytes,7,rep,name=privileged_rules,json=privilegedRules" json:"privileged_rules,omitempty"`
}
...
func (x *VerifierPolicies) GetPrivilegedRules() []*RuleV2 {
	if x != nil {
		return x.PrivilegedRules
	}
	return nil
}
...
var file_biscuit_proto_rawDesc = []byte{
	...
	0x32, 0x05, 0x2e, 0x49, 0x44, 0x56, 0x32, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0xdf, 0x01, 0x0a,
	0x04, 0x49, 0x44, 0x56, 0x32, 0x12, 0x18, 0x0a, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x18,
	...
	0x52, 0x07, 0x69, 0x6e, 0x74, 0x65, 0x67, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x06, 0x73, 0x74, 0x72,
	0x69, 0x6e, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x73, 0x74, 0x72,
	0x69, 0x6e, 0x67, 0x12, 0x14, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	0x01, 0x22, 0xff, 0x01, 0x0a, 0x10, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x72, 0x50, 0x6f,
	...
	0x32, 0x0a, 0x10, 0x70, 0x72, 0x69, 0x76, 0x69, 0x6c, 0x65, 0x67, 0x65, 0x64, 0x5f, 0x72, 0x75,
	0x6c, 0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x52, 0x75, 0x6c, 0x65,
	0x56, 0x32, 0x52, 0x0f, 0x70, 0x72, 0x69, 0x76, 0x69, 0x6c, 0x65, 0x67, 0x65, 0x64, 0x52, 0x75,
	0x6c, 0x65, 0x73, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x3b, 0x70, 0x62,
}
...
var file_biscuit_proto_goTypes = []interface{}{
	...
	(*SymbolConstraintV2)(nil), // 19: SymbolConstraintV2
	(*SymbolSet)(nil),          // 20: SymbolSet
...
var file_biscuit_proto_depIdxs = []int32{
	...
	23, // 9: RuleV2.expressions:type_name -> ExpressionV2
	...
	19, // 17: ConstraintV2.symbol:type_name -> SymbolConstraintV2
	21, // 18: ConstraintV2.bytes:type_name -> BytesConstraintV2
	15, // 19: IntConstraintV2.in_set:type_name -> IntSet
	15, // 20: IntConstraintV2.not_in_set:type_name -> IntSet
	17, // 21: StringConstraintV2.in_set:type_name -> StringSet
	17, // 22: StringConstraintV2.not_in_set:type_name -> StringSet
	20, // 23: SymbolConstraintV2.in_set:type_name -> SymbolSet
	20, // 24: SymbolConstraintV2.not_in_set:type_name -> SymbolSet
	22, // 25: BytesConstraintV2.in_set:type_name -> BytesSet
	22, // 26: BytesConstraintV2.not_in_set:type_name -> BytesSet
	24, // 27: ExpressionV2.ops:type_name -> Op
	11, // 28: Op.value:type_name -> IDV2
	25, // 29: Op.unary:type_name -> OpUnary
	26, // 30: Op.Binary:type_name -> OpBinary
	0,  // 31: OpUnary.kind:type_name -> OpUnary.Kind
	1,  // 32: OpBinary.kind:type_name -> OpBinary.Kind
	8,  // 33: Policy.queries:type_name -> RuleV2
	2,  // 34: Policy.kind:type_name -> Policy.Kind
	7,  // 35: VerifierPolicies.facts:type_name -> FactV2
	8,  // 36: VerifierPolicies.rules:type_name -> RuleV2
	9,  // 37: VerifierPolicies.checks:type_name -> CheckV2
	27, // 38: VerifierPolicies.policies:type_name -> Policy
	8,  // 39: VerifierPolicies.privileged_rules:type_name -> RuleV2
...
func file_biscuit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_biscuit_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SymbolConstraintV2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_biscuit_proto_msgTypes[16].OneofWrappers = []interface{}{
		(*SymbolConstraintV2_InSet)(nil),
		(*SymbolConstraintV2_NotInSet)(nil),
	}
